...
public class DelegateInstrumentation extends Instrumentation {
    ...
    public void doMyOperation(Context who, Intent intent) {
        Log.e(TAG, "source Acitivity name " + who.getClass().getName() + ", next activity name:" + intent.getComponent().getClassName());
